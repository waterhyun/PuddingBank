...
### 2024/11/26
- **인증 시스템 개선**
  - 토큰 저장 위치를 로컬에서 세션으로 변경
  - 비밀번호 변경 후 자동 로그아웃 처리 추가

- **환율 계산기 기능 개선**
  - 중복 새로고침 에러 수정
  - 국가 선택 로직 개선 및 중복 문제 해결

- **UI/UX 디자인 개선**
  - 예적금, 대출 상품 페이지 디자인 개선
  - 추천 서비스 폰트 적용 및 디자인 개선
  - 플로팅 버튼 생성, 호버 효과에 지속적인 부유 애니메이션 추가
  - 브라우저 창 크기에 따른 네비게이션 바 깨짐 문제 해결
  - 서비스 안내창 디자인 구현
  - 네비게이션 바 로그아웃 버튼 디자인 수정

- **위치 기반 서비스 개선**
  - 현재 위치 기반 은행 검색 로직 버그 수정
